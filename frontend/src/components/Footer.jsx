...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-[#18181f] py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[#6b6b7b] leading-relaxed">
              The modern platform for technical interviews.
            </p>
          </div>
        ...
        {/* Bottom */}
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-[#18181f]">
